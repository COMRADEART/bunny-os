...
visual-setup:
	$(PYTHON) visual/tools/visual.py setup

visual-preview:
	$(PYTHON) visual/tools/visual.py preview

visual-preview-nested:
	$(PYTHON) visual/tools/visual.py preview-nested

visual-build:
	$(PYTHON) visual/tools/visual.py build

visual-test:
	$(PYTHON) visual/tools/visual.py test

visual-a11y:
	$(PYTHON) visual/tools/visual.py a11y

visual-screenshot:
	$(PYTHON) visual/tools/visual.py screenshot

visual-package:
	$(PYTHON) visual/tools/visual.py package
...
# Visual Phase V3 — experimental native Wayland shell.
# BUNNY WAYLAND SHELL EXPERIMENT — NOT RELEASE QUALIFIED — DO NOT USE AS THE
# DEFAULT SESSION. None of these targets build, sign or publish an image.

bunny-shell-setup:
	$(PYTHON) visual-v3/tools/visual_v3.py setup

bunny-shell-build:
	$(PYTHON) visual-v3/tools/visual_v3.py build

bunny-shell-run-nested:
	$(PYTHON) visual-v3/tools/visual_v3.py run-nested

bunny-shell-run-vm:
	$(PYTHON) visual-v3/tools/visual_v3.py run-vm

bunny-shell-test:
	$(PYTHON) visual-v3/tools/visual_v3.py test

bunny-shell-protocol-test:
	$(PYTHON) visual-v3/tools/visual_v3.py protocol-test

bunny-shell-a11y-test:
	$(PYTHON) visual-v3/tools/visual_v3.py a11y-test

bunny-shell-security-test:
	$(PYTHON) visual-v3/tools/visual_v3.py security-test

bunny-shell-performance-test:
	$(PYTHON) visual-v3/tools/visual_v3.py performance-test

bunny-shell-compatibility-test:
	$(PYTHON) visual-v3/tools/visual_v3.py compatibility-test

bunny-shell-package:
	$(PYTHON) visual-v3/tools/visual_v3.py package

bunny-shell-clean:
	$(PYTHON) visual-v3/tools/visual_v3.py clean
