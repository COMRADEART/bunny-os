...
class RuntimeGateway(TypingProtocol):
    ...
    def desktop_actions_list(self) -> Mapping[str, Any]: ...
    def desktop_actions_status(self) -> Mapping[str, Any]: ...
    def desktop_action_explain(self, **params: Any) -> Mapping[str, Any]: ...
    def desktop_action_cancel(self, **params: Any) -> Mapping[str, Any]: ...
    def desktop_action_undo(self, **params: Any) -> Mapping[str, Any]: ...
    def desktop_action_history(self, **params: Any) -> Mapping[str, Any]: ...
