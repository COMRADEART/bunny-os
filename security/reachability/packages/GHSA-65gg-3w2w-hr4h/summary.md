# GHSA-65gg-3w2w-hr4h — github.com/containers/podman/v5 v5.0.0-20260626000000-d5ac989fc69c+dirty
...
`5.5.2`. Fedora 44 ships no build carrying it: `dnf check-update`
