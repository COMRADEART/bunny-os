...
const PRESENTATION_KEYS = new Set([
    ...
    'character-educational-appearances',
    'character-success-appearances',
    'character-error-appearances',
    'character-onboarding-appearances',
    'reduced-motion',
    'panel-transparency',
    'dock-autohide',
...
export class ModeController {
    ...
    snapshot() {
        ...
        return Object.freeze({
            ...
            characterReducedMotion: this._settings.get_boolean('character-reduced-motion'),
            educationalAppearances: this._settings.get_boolean('character-educational-appearances'),
            successAppearances: this._settings.get_boolean('character-success-appearances'),
            errorAppearances: this._settings.get_boolean('character-error-appearances'),
            onboardingAppearances: this._settings.get_boolean('character-onboarding-appearances'),
